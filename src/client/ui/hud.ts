...
export class MatchHud {
  ...
  constructor(container: HTMLElement) {
    ...
    this.root.innerHTML = `<div class="bowdle-score"></div><div class="bowdle-timer"></div><div class="bowdle-feed" data-testid="kill-feed"></div><div class="bowdle-marker">✕</div><div class="bowdle-damage"></div><div class="bowdle-scoreboard"></div><div class="bowdle-center"></div><div class="bowdle-moment"></div>`;
