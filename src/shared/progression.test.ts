...
describe("progression", () => {
  ...
  it("rewards finishing, fighting and winning", () => {
    expect(matchReward({ kills: 0, assists: 0, won: false })).toEqual({ xp: 100, ink: 10, breakdown: [
      ...
      { label: "Headshots", xp: 0, ink: 0 }, { label: "Long shots", xp: 0, ink: 0 }, { label: "Rope cuts", xp: 0, ink: 0 }, { label: "Swats", xp: 0, ink: 0 }, { label: "Win", xp: 0, ink: 0 }, { label: "Medals", xp: 0, ink: 0 },
    ] });
    expect(matchReward({ kills: 4, assists: 2, won: true })).toEqual({ xp: 100 + 200 + 50 + 200, ink: 24, breakdown: [
      ...
      { label: "Headshots", xp: 0, ink: 0 }, { label: "Long shots", xp: 0, ink: 0 }, { label: "Rope cuts", xp: 0, ink: 0 }, { label: "Swats", xp: 0, ink: 0 }, { label: "Win", xp: 200, ink: 10 }, { label: "Medals", xp: 0, ink: 0 },
    ] });
