...
describe("room match statistics", () => {
  ...
  it("sends human and guest stats, resets a death streak and stores precision and weapon XP", async () => {
    ...
    expect(message.stats).toEqual({ kills: 3, deaths: 1, assists: 0, headshots: 1, longShots: 1, longestShotM: 45, daggerKills: 1, boulderKills: 1, zipKills: 0, robinHoods: 0, ropeCuts: 0, streak: 1, bestStreak: 2, won: true });
