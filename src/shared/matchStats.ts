...
export type MatchStats = { kills: number; deaths: number; assists: number; headshots: number; longShots: number; longestShotM: number; daggerKills: number; boulderKills: number; zipKills: number; robinHoods: number; ropeCuts: number; swats: number; scatterKills: number; tetherRides: number; streak: number; bestStreak: number; won: boolean };
export function createMatchStats(): MatchStats { return { kills: 0, deaths: 0, assists: 0, headshots: 0, longShots: 0, longestShotM: 0, daggerKills: 0, boulderKills: 0, zipKills: 0, robinHoods: 0, ropeCuts: 0, swats: 0, scatterKills: 0, tetherRides: 0, streak: 0, bestStreak: 0, won: false }; }
